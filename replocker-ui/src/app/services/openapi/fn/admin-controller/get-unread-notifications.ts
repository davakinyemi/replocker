...
export function getUnreadNotifications(http: HttpClient, rootUrl: string, params?: GetUnreadNotifications$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseNotificationResponse>> {
...
getUnreadNotifications.PATH = '/admins/me/notification/unread';
